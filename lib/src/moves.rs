...
impl SkatingMoveId {
    ...
    pub(crate) fn construct<'a>(
        ...
        Ok(match self {
            ...
            Self::LoopJump(count) => Box::new(jump::Loop::from_params(
                input,
                text_pos,
                pre_transition,
                entry_code,
            ...
            Self::Flip(count) => Box::new(jump::Flip::from_params(
                input,
                text_pos,
                pre_transition,
                entry_code,
            ...
            Self::Lutz(count) => Box::new(jump::Lutz::from_params(
                input,
                text_pos,
                pre_transition,
                entry_code,
            ...
            Self::Axel(count) => Box::new(jump::Axel::from_params(
                input,
                text_pos,
                pre_transition,
                entry_code,
